...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  pistol: {
    ...
    reloadTime: 1.2, spread: 1.2, adsSpread: 0.35, pellets: 1, range: 160, recoil: 1.6, recoilYaw: 0.4, kick: 0.06, adsZoom: 0.78, adsTime: 0.12,
  ...
  smg: {
    ...
    reloadTime: 1.7, spread: 2.6, adsSpread: 1.1, pellets: 1, range: 120, recoil: 0.7, recoilYaw: 0.5, kick: 0.04, adsZoom: 0.73, adsTime: 0.12,
  ...
  rifle: {
    ...
    reloadTime: 2.0, spread: 1.6, adsSpread: 0.45, pellets: 1, range: 220, recoil: 1.0, recoilYaw: 0.35, kick: 0.05, adsZoom: 0.65, adsTime: 0.16,
  ...
  shotgun: {
    ...
    reloadTime: 2.4, spread: 6.5, adsSpread: 4.5, pellets: 9, range: 60, recoil: 4.5, recoilYaw: 1.2, kick: 0.16, adsZoom: 0.78, adsTime: 0.14,
  ...
  rocket: {
    ...
    reloadTime: 2.6, spread: 0.3, adsSpread: 0.2, pellets: 1, range: 300, recoil: 3.5, recoilYaw: 0.8, kick: 0.25, adsZoom: 0.7, adsTime: 0.18,
