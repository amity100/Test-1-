...
const EN: Record<string, string> = {
  ...
  'briefing.text':
    'Kessler Industries invented the rift gate, and now they are building an empire on it: a 100-metre tower rising over the harbour. You stole their prototype Rift Gauntlet. No gun, no armour: one rift pair, a hidden blade, and whatever Kessler throws at you. Climb from the pier to the roof and take down Director Voss.',
  ...
  'rule.2': 'The rift is your weapon: whatever passes through can hurt anyone. Up close, your hidden blade kills.',
  ...
  'hint.door':
    "Rifts are doors. Look across the channel and hold <kbd>LMB</kbd>: the orange <b>ENTRANCE</b> opens in front of you, time slows and a ghost shows where you’ll come out. Let go: the blue <b>EXIT</b> opens there. Walk through. (A quick click puts the exit where you look.)",
  'hint.door.pad':
    "Rifts are doors. Look across the channel and hold <kbd>RT</kbd>: the orange <b>ENTRANCE</b> opens in front of you, time slows and a ghost shows where you’ll come out. Let go: the blue <b>EXIT</b> opens there. Walk through. (A quick press puts the exit where you look.)",
  'hint.door.touch':
  ...
  'hint.returnToSender.pad':
    "His gun can’t hurt Kessler, until the bullets pass through your rift. Aim near him and press <kbd>LT</kbd> <b>REFLECT</b>: a rift on his muzzle, and his burst comes out beside him, into him.",
  'hint.returnToSender.touch':
    "His gun can’t hurt Kessler, until the bullets pass through your rift. Aim near him and tap <b>REFLECT</b>: a rift on his muzzle, and his burst comes out beside him, into him.",
  'hint.slingshot':
  ...
  'hint.matador':
    "The brute charges in a straight line. Aim near him and press <kbd>RMB</kbd> <b>REFLECT</b>: he charges now, into a rift in front of you, and comes out over the edge. Olé.",
  'hint.matador.pad':
    "The brute charges in a straight line. Aim near him and press <kbd>LT</kbd> <b>REFLECT</b>: he charges now, into a rift in front of you, and comes out over the edge. Olé.",
  'hint.matador.touch':
    "The brute charges in a straight line. Aim near him and tap <b>REFLECT</b>: he charges now, into a rift in front of you, and comes out over the edge. Olé.",
  'hint.grenade':
    "Watch the arc: the ring shows where it lands. Aim near the thrower and press <kbd>RMB</kbd> <b>REFLECT</b>: a rift over his throw, and his grenade comes straight back at him.",
  'hint.grenade.pad':
    "Watch the arc: the ring shows where it lands. Aim near the thrower and press <kbd>LT</kbd> <b>REFLECT</b>: a rift over his throw, and his grenade comes straight back at him.",
  'hint.grenade.touch':
    "Watch the arc: the ring shows where it lands. Aim near the thrower and tap <b>REFLECT</b>: a rift over his throw, and his grenade comes straight back at him.",
  'hint.shield':
    "His shield blocks everything from the front, but not the floor: <kbd>LMB</kbd> on him grabs him anyway. <kbd>V</kbd> SHOVE knocks him off balance. Up close, <kbd>F</kbd>: the blade goes through the shield.",
  'hint.shield.pad':
    "His shield blocks everything from the front, but not the floor: <kbd>RT</kbd> on him grabs him anyway. <kbd>RB</kbd> SHOVE knocks him off balance. Up close, <kbd>X</kbd>: the blade goes through the shield.",
  'hint.shield.touch':
    "His shield blocks everything from the front, but not the floor: <b>PORTAL</b> on him grabs him anyway. <b>SHOVE</b> knocks him off balance. Up close, <b>ACTION</b>: the blade goes through the shield.",
  'hint.firingLine':
    "The sniper’s beam charges for a second. Aim near him and press <kbd>RMB</kbd> <b>REFLECT</b>: he fires at once, and the beam comes back into him. Look at another guard to send it there.",
  'hint.firingLine.pad':
    "The sniper’s beam charges for a second. Aim near him and press <kbd>LT</kbd> <b>REFLECT</b>: he fires at once, and the beam comes back into him. Look at another guard to send it there.",
  'hint.firingLine.touch':
    "The sniper’s beam charges for a second. Aim near him and tap <b>REFLECT</b>: he fires at once, and the beam comes back into him. Look at another guard to send it there.",
  'hint.hijack':
  ...
  'hint.borrowedGun':
    "The turret never stops shooting. Aim near it and press <kbd>RMB</kbd> <b>REFLECT</b>: a rift takes its stream, and the other end goes wherever you look. Look at its friends. Borrowed gun.",
  'hint.borrowedGun.pad':
    "The turret never stops shooting. Aim near it and press <kbd>LT</kbd> <b>REFLECT</b>: a rift takes its stream, and the other end goes wherever you look. Look at its friends. Borrowed gun.",
  'hint.borrowedGun.touch':
    "The turret never stops shooting. Aim near it and tap <b>REFLECT</b>: a rift takes its stream, and the other end goes wherever you drag your view. Look at its friends. Borrowed gun.",
  'hint.boss':
    "Voss catches straight shots with his own rift, and no grab moves him. Hit him from behind or from above; up close the blade cuts him, and he blinks away; stunned, <b>LOOP</b> takes him. Caught halfway through your rift? <kbd>X</kbd> closes it on him.",
  'hint.boss.pad':
    "Voss catches straight shots with his own rift, and no grab moves him. Hit him from behind or from above; up close the blade cuts him, and he blinks away; stunned, <b>LOOP</b> takes him. Caught halfway through your rift? <kbd>LB</kbd> closes it on him.",
  'hint.boss.touch':
    "Voss catches straight shots with his own rift, and no grab moves him. Hit him from behind or from above; up close the blade cuts him, and he blinks away; stunned, <b>LOOP</b> takes him. Caught halfway through your rift? <b>✕</b> closes it on him.",
  ...
  'hint.strikes':
    "<b>STRIKES</b> cost rift charge ⚡ (kills without a strike refill it, the blade's too). Aim near an enemy: <kbd>RMB</kbd> <b>REFLECT</b> his own gun fires into him · <kbd>Q</kbd> <b>LOOP</b> he falls forever (<kbd>Q</kbd> again: geyser, hold: human cannon) · <kbd>E</kbd> <b>SWAP</b> places · <kbd>R</kbd> <b>DASH</b> into him.",
  'hint.strikes.pad':
    "<b>STRIKES</b> cost rift charge ⚡ (kills without a strike refill it, the blade's too). Aim near an enemy: <kbd>LT</kbd> <b>REFLECT</b> his own gun fires into him · <kbd>Y</kbd> <b>LOOP</b> he falls forever (<kbd>Y</kbd> again: geyser, hold: human cannon) · <kbd>◀</kbd> <b>SWAP</b> places · <kbd>▶</kbd> <b>DASH</b> into him.",
  'hint.strikes.touch':
    "<b>STRIKES</b> (the round buttons on the left) cost rift charge ⚡; kills without a strike refill it, the blade's too. Aim near an enemy: <b>REFLECT</b> his own gun fires into him · <b>LOOP</b> he falls forever (again: geyser, hold: human cannon) · <b>SWAP</b> places · <b>DASH</b> into him.",
  ...
  'gate.noExit': 'Open an exit first',
  ...
  // rift vision: what each enemy is doing (a searching man shows as suspicious)
  'state.idle': 'idle',
  'state.patrol': 'patrol',
  ...
  'strike.noCharge': 'No rift charge: a kill without a strike refills one',
  ...
  'strike.cantFire': "He can't shoot right now",
  ...
  'ctl.action': 'ACTION: hidden blade (close up), grab, throw, hijack, lift',
  ...
  'key.space': 'Space',
  'ctl.padLine':
    'RT PORTAL (while held: LT cancel · Y flip · D-pad ←/→ distance) · LT REFLECT · Y LOOP · D-pad ← SWAP · D-pad → DASH · LB close · RB shove · A jump · X blade / action · B crouch · L3 sprint · D-pad ↓ vision · D-pad ↑ photo · View clip · Start pause',
...
const HE: Record<string, string> = {
  ...
  'briefing.text':
    'קסלר תעשיות המציאו את שער הפורטל, ועכשיו הם בונים עליו אימפריה: מגדל של מאה מטר מעל הנמל. גנבת להם את אב־הטיפוס של כפפת הפורטלים. אין לך נשק ואין לך שריון: זוג פורטלים אחד, להב נסתר, ומה שקסלר יזרקו עליך. טפס מהרציף עד הגג, והפל את המנהל ווֹס.',
  ...
  'rule.2': 'הפורטל הוא הנשק שלך: מה שעובר דרכו פוגע בכל אחד. מקרוב, הלהב הנסתר שלך הורג.',
  'rule.3': 'שני הקצוות בשליטה שלך. סגור פורטל על משהו באמצע, והוא נחתך.',

  'hint.door':
    "פורטל הוא דלת. הסתכל לצד השני של התעלה והחזק <kbd>קליק שמאלי</kbd>: ה<b>כניסה</b> הכתומה נפתחת מולך, הזמן מאט, ודמות רפאים מראה איפה תצא. שחרר: ה<b>יציאה</b> הכחולה נפתחת שם. עבור דרכה. (קליק מהיר שם את היציאה איפה שאתה מסתכל.)",
  'hint.door.pad':
    "פורטל הוא דלת. הסתכל לצד השני של התעלה והחזק <kbd>RT</kbd>: ה<b>כניסה</b> הכתומה נפתחת מולך, הזמן מאט, ודמות רפאים מראה איפה תצא. שחרר: ה<b>יציאה</b> הכחולה נפתחת שם. עבור דרכה. (לחיצה מהירה שמה את היציאה איפה שאתה מסתכל.)",
  'hint.door.touch':
  ...
  'hint.returnToSender.pad':
    "הנשק שלו לא פוגע באנשי קסלר, עד שהכדורים עוברים בפורטל שלך. כוון לידו ולחץ <kbd>LT</kbd> <b>מחזיר</b>: פורטל על הלוע של הנשק שלו, והצרור יוצא לידו, לתוכו.",
  'hint.returnToSender.touch':
    "הנשק שלו לא פוגע באנשי קסלר, עד שהכדורים עוברים בפורטל שלך. כוון לידו וגע ב<b>מחזיר</b>: פורטל על הלוע של הנשק שלו, והצרור יוצא לידו, לתוכו.",
  'hint.slingshot':
  ...
  'hint.matador':
    "הענק מסתער בקו ישר. כוון לידו ולחץ <kbd>קליק ימני</kbd> <b>מחזיר</b>: הוא מסתער מיד, לתוך פורטל שמולך, ויוצא מעבר לקצה. אולה.",
  'hint.matador.pad':
    "הענק מסתער בקו ישר. כוון לידו ולחץ <kbd>LT</kbd> <b>מחזיר</b>: הוא מסתער מיד, לתוך פורטל שמולך, ויוצא מעבר לקצה. אולה.",
  'hint.matador.touch':
    "הענק מסתער בקו ישר. כוון לידו וגע ב<b>מחזיר</b>: הוא מסתער מיד, לתוך פורטל שמולך, ויוצא מעבר לקצה. אולה.",
  'hint.grenade':
    "שים לב לקשת: הטבעת מראה איפה הרימון ינחת. כוון ליד הזורק ולחץ <kbd>קליק ימני</kbd> <b>מחזיר</b>: פורטל מעל הזריקה שלו, והרימון שלו חוזר ישר אליו.",
  'hint.grenade.pad':
    "שים לב לקשת: הטבעת מראה איפה הרימון ינחת. כוון ליד הזורק ולחץ <kbd>LT</kbd> <b>מחזיר</b>: פורטל מעל הזריקה שלו, והרימון שלו חוזר ישר אליו.",
  'hint.grenade.touch':
    "שים לב לקשת: הטבעת מראה איפה הרימון ינחת. כוון ליד הזורק וגע ב<b>מחזיר</b>: פורטל מעל הזריקה שלו, והרימון שלו חוזר ישר אליו.",
  'hint.shield':
    "המגן שלו חוסם הכול מלפנים, אבל לא את הרצפה: <kbd>קליק שמאלי</kbd> עליו חוטף אותו בכל זאת. <kbd>V</kbd> דוחף אותו משיווי משקל. מקרוב, <kbd>F</kbd>: הלהב עובר דרך המגן.",
  'hint.shield.pad':
    "המגן שלו חוסם הכול מלפנים, אבל לא את הרצפה: <kbd>RT</kbd> עליו חוטף אותו בכל זאת. <kbd>RB</kbd> דוחף אותו משיווי משקל. מקרוב, <kbd>X</kbd>: הלהב עובר דרך המגן.",
  'hint.shield.touch':
    "המגן שלו חוסם הכול מלפנים, אבל לא את הרצפה: <b>פורטל</b> עליו חוטף אותו בכל זאת. <b>דחיפה</b> מוציאה אותו משיווי משקל. מקרוב, <b>פעולה</b>: הלהב עובר דרך המגן.",
  'hint.firingLine':
    "הקרן של הצלף נטענת שנייה אחת. כוון לידו ולחץ <kbd>קליק ימני</kbd> <b>מחזיר</b>: הוא יורה מיד, והקרן חוזרת לתוכו. הסתכל על שומר אחר כדי לשלוח אותה אליו.",
  'hint.firingLine.pad':
    "הקרן של הצלף נטענת שנייה אחת. כוון לידו ולחץ <kbd>LT</kbd> <b>מחזיר</b>: הוא יורה מיד, והקרן חוזרת לתוכו. הסתכל על שומר אחר כדי לשלוח אותה אליו.",
  'hint.firingLine.touch':
    "הקרן של הצלף נטענת שנייה אחת. כוון לידו וגע ב<b>מחזיר</b>: הוא יורה מיד, והקרן חוזרת לתוכו. הסתכל על שומר אחר כדי לשלוח אותה אליו.",
  'hint.hijack':
  ...
  'hint.borrowedGun':
    "הצריח לא מפסיק לירות. כוון לידו ולחץ <kbd>קליק ימני</kbd> <b>מחזיר</b>: פורטל לוקח את הצרור, והקצה השני הולך לאן שאתה מסתכל. הסתכל על החברים שלו. רובה בהשאלה.",
  'hint.borrowedGun.pad':
    "הצריח לא מפסיק לירות. כוון לידו ולחץ <kbd>LT</kbd> <b>מחזיר</b>: פורטל לוקח את הצרור, והקצה השני הולך לאן שאתה מסתכל. הסתכל על החברים שלו. רובה בהשאלה.",
  'hint.borrowedGun.touch':
    "הצריח לא מפסיק לירות. כוון לידו וגע ב<b>מחזיר</b>: פורטל לוקח את הצרור, והקצה השני הולך לאן שאתה גורר את המבט. הסתכל על החברים שלו. רובה בהשאלה.",
  'hint.boss':
    "ווֹס תופס בפורטל שלו כל מה שנורה ישר עליו, ושום חטיפה לא מזיזה אותו. תפגע בו מאחור או מלמעלה; מקרוב הלהב חותך אותו, והוא נמלט דרך הפורטל שלו; כשהוא המום, <b>לולאה</b> לוקחת אותו. נתקע באמצע הפורטל שלך? <kbd>X</kbd> סוגר אותו עליו.",
  'hint.boss.pad':
    "ווֹס תופס בפורטל שלו כל מה שנורה ישר עליו, ושום חטיפה לא מזיזה אותו. תפגע בו מאחור או מלמעלה; מקרוב הלהב חותך אותו, והוא נמלט דרך הפורטל שלו; כשהוא המום, <b>לולאה</b> לוקחת אותו. נתקע באמצע הפורטל שלך? <kbd>LB</kbd> סוגר אותו עליו.",
  'hint.boss.touch':
    "ווֹס תופס בפורטל שלו כל מה שנורה ישר עליו, ושום חטיפה לא מזיזה אותו. תפגע בו מאחור או מלמעלה; מקרוב הלהב חותך אותו, והוא נמלט דרך הפורטל שלו; כשהוא המום, <b>לולאה</b> לוקחת אותו. נתקע באמצע הפורטל שלך? <b>✕</b> סוגר אותו עליו.",
  ...
  'hint.strikes':
    "<b>מתקפות</b> עולות טעינה ⚡ (חיסולים בלי מתקפה ממלאים אותה, גם בלהב). כוון ליד אויב: <kbd>קליק ימני</kbd> <b>מחזיר</b>: הנשק שלו יורה בו · <kbd>Q</kbd> <b>לולאה</b>: הוא נופל בלי סוף (<kbd>Q</kbd> שוב: גייזר, החזקה: תותח אנושי) · <kbd>E</kbd> <b>החלפה</b>: מתחלפים במקומות · <kbd>R</kbd> <b>זינוק</b>: עפים לתוכו.",
  'hint.strikes.pad':
    "<b>מתקפות</b> עולות טעינה ⚡ (חיסולים בלי מתקפה ממלאים אותה, גם בלהב). כוון ליד אויב: <kbd>LT</kbd> <b>מחזיר</b>: הנשק שלו יורה בו · <kbd>Y</kbd> <b>לולאה</b>: הוא נופל בלי סוף (<kbd>Y</kbd> שוב: גייזר, החזקה: תותח אנושי) · <kbd>◀</kbd> <b>החלפה</b>: מתחלפים במקומות · <kbd>▶</kbd> <b>זינוק</b>: עפים לתוכו.",
  'hint.strikes.touch':
    "<b>מתקפות</b> (הכפתורים העגולים משמאל) עולות טעינה ⚡; חיסולים בלי מתקפה ממלאים אותה, גם בלהב. כוון ליד אויב: <b>מחזיר</b>: הנשק שלו יורה בו · <b>לולאה</b>: הוא נופל בלי סוף (שוב: גייזר, החזקה: תותח אנושי) · <b>החלפה</b>: מתחלפים במקומות · <b>זינוק</b>: עפים לתוכו.",
  ...
  'state.idle': 'רגוע',
  'state.patrol': 'בסיור',
  'state.suspicious': 'חשדן',
  'state.combat': 'בקרב',
  'state.stagger': 'מתנודד',
  'state.charge': 'מסתער',
  'state.launched': 'באוויר',
  'state.downed': 'על הרצפה',
  'state.stunned': 'המום',
  'state.dead': 'מת',
  ...
  'strike.noCharge': 'אין טעינה: חיסול בלי מתקפה ממלא אחת',
  ...
  'strike.cantFire': 'הוא לא יכול לירות עכשיו',
  ...
  'ctl.action': 'פעולה: להב נסתר (מקרוב), תפיסה, זריקה, השתלטות, מעלית',
  ...
  'key.space': 'רווח',
  'ctl.padLine':
    'RT פורטל (בזמן החזקה: LT ביטול · Y היפוך · חצים ←/→ מרחק) · LT מחזיר · Y לולאה · חץ ← החלפה · חץ → זינוק · LB סגירה · RB דחיפה · A קפיצה · X להב / פעולה · B כריעה · L3 ריצה · חץ ↓ ראיית פורטל · חץ ↑ צילום · View קליפ · Start הפסקה',
