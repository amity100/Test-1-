...
const EN: Record<string, string> = {
  ...
  'hint.strikes': '<b>STRIKES</b>: aim near an enemy and press. <b>1 REFLECT</b> sends his bullets back · <b>2 GEYSER</b> throws him into the sky · <b>3 DROP</b> throws him off the edge (or out of the sky).',
...
const HE: Record<string, string> = {
  ...
  'hint.strikes': '<b>מתקפות</b>: כוונו ליד אויב ולחצו. <b>1 מחזיר</b> מחזיר לו את הכדורים · <b>2 גייזר</b> זורק אותו לשמיים · <b>3 השלכה</b> זורקת אותו מהקצה (או מהשמיים).',
