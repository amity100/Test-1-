...
const STR = {
  en: {
    ...
    briefing: 'Kessler Maritime runs guns through Pier 9. Harbormaster Voss keeps the shipping ledger on him, up on the control-tower deck. You carry a blade and a rift: you cannot fight a guard face to face, but you can open a rift behind him and strike, or fall on him from the sky. Guards work in groups that watch each other; kill one where his friends can see and they get one breath to raise the alarm. Chain kills inside that breath.',
    objManifest: 'Eliminate Harbormaster Voss on the control-tower deck and take the ledger',
    ...
    manifestTaken: 'Voss is down, ledger taken. Get to the helicopter on the barge.',
    ...
    hintMove: 'Two guards chat on the quay right below you. Walk to the roof edge. Your blade only works <b>through a rift</b> — aim at one, strike, then chain to the other before he reacts.',
    ...
    hintTakedown: 'Aim at a guard — the rift locks <b>behind him</b>. Open it and you strike automatically.',
    hintTakedownTouch: 'Aim at a guard — the rift locks <b>behind him</b>. Tap OPEN and you strike automatically.',
    hintSnatch: 'A guard walked up to the far end of your rift? <b>PULL</b> drags him through — a trap, not a gun.',
    ...
    hintWitness: 'A mate saw that. The 👁 ring is his reaction time — kill him before it drains, or he calls the squad.',
    hintHeavy: 'Armoured guards can\'t be cut from behind. Aim a rift <b>above</b> him — DROP onto him from the sky.',
    noWeapon: 'You can\'t take a guard on foot. Strike through a rift — or hit him while he\'s stunned.',
    hintHurl: 'Throw the body <b>into</b> a rift — it flies out the other end and knocks down whoever it hits.',
    hintStrikeKbm: 'Locked on. <b>LEFT CLICK</b> = STRIKE: you dash through and cut him down. Another kill within the beat = CHAIN.',
    hintStrikePad: 'Locked on. <b>RT</b> = STRIKE: you dash through and cut him down. Another kill within the beat = CHAIN.',
    hintStrikeTouch: 'Locked on. Tap <b>OPEN</b> = STRIKE: you dash through and cut him down. Another kill within the beat = CHAIN.',
    stunned: 'Stunned! Finish him.',
    podSilenced: 'Group silenced — no one saw a thing.',
    objPods: 'Optional: silence every guard group without an alarm ({n}/{m})',
    move_strike: 'STRIKE',
    move_drop: 'DROP',
    move_takedown: 'TAKEDOWN',
    move_pull: 'PULL',
    move_hurl: 'HURL',
    see: 'SEE',
    swapHint: 'Q/E ⇄',
    blockArmoured: 'ARMOURED — AIM ABOVE HIM',
    blockSees: 'HE SEES YOU',
    blockFar: 'TOO FAR',
    bestChain: 'Best chain',
    movesUsed: 'Kill moves used',
    controlsHtml: `
      <div class="ctl-grid">
        ...
        <div><b>F</b><span>Pull · Carry · Throw · Use</span></div>
        ...
        <div class="hl"><b>Q / E</b><span>Rift facing · swap STRIKE ⇄ DROP</span></div>
      ...
      <p class="ctl-note">Gamepad: LT aim · RT open · LB/RB distance · D-pad facing · X action · B crouch · A jump</p>`,
  },
  he: {
    title: 'THRESHOLD',
    ...
    briefing: 'חברת קסלר ימית מבריחה נשק דרך רציף 9. מנהל הנמל פוֹס מחזיק את יומן המשלוחים, למעלה במרפסת מגדל הפיקוח. יש לך סכין ופורטל: פנים מול פנים אין לך סיכוי מול שומר, אבל אפשר לפתוח פורטל מאחוריו ולתקוף, או ליפול עליו מהשמיים. השומרים עובדים בקבוצות ושומרים אחד על השני. אם תחסל אחד מול העיניים של החברים שלו, יש להם רגע אחד להזעיק עזרה. תשרשר את החיסולים בתוך הרגע הזה.',
    objManifest: 'חסל את מנהל הנמל פוֹס במרפסת מגדל הפיקוח וקח את היומן',
    ...
    lostBark: '״כנראה כלום…״',
    manifestTaken: 'פוס חוסל והיומן אצלך. רוץ למסוק שעל הדוברה.',
    ...
    hintMove: 'שני שומרים מדברים על הרציף ממש מתחתיך. גש לקצה הגג. הסכין שלך עובדת רק <b>דרך פורטל</b> — כוון לאחד, תקוף, ומיד שרשר לשני לפני שהוא מגיב.',
    ...
    hintTakedown: 'כוון לשומר — הפורטל ננעל <b>מאחוריו</b>. פתח אותו ואתה תוקף אוטומטית.',
    hintTakedownTouch: 'כוון לשומר — הפורטל ננעל <b>מאחוריו</b>. גע בפתח ואתה תוקף אוטומטית.',
    hintSnatch: 'שומר הגיע לצד השני של הפורטל שלך? <b>משיכה</b> גוררת אותו אליך — מלכודת, לא רובה.',
    ...
    hintWitness: 'חבר שלו ראה. הטבעת 👁 היא זמן התגובה שלו — חסל אותו לפני שהיא נגמרת, אחרת הוא מזעיק את כל החוליה.',
    hintHeavy: 'שומר משוריין אי אפשר לחסל מאחור. כוון פורטל <b>מעליו</b> — ונחת עליו מהשמיים (DROP).',
    noWeapon: 'ברגל אי אפשר לחסל שומר. תקוף דרך פורטל — או חסל אותו כשהוא המום.',
    hintHurl: 'זרוק את הגופה <b>לתוך</b> פורטל — היא עפה מהצד השני ומפילה את מי שהיא פוגעת בו.',
    hintStrikeKbm: 'ננעלת עליו. <b>קליק שמאלי</b> = STRIKE: אתה מזנק דרך הפורטל ומחסל. חיסול נוסף בזמן הפעימה = שרשרת.',
    hintStrikePad: 'ננעלת עליו. <b>RT</b> = STRIKE: אתה מזנק דרך הפורטל ומחסל. חיסול נוסף בזמן הפעימה = שרשרת.',
    hintStrikeTouch: 'ננעלת עליו. גע ב<b>פתח</b> = STRIKE: אתה מזנק דרך הפורטל ומחסל. חיסול נוסף בזמן הפעימה = שרשרת.',
    stunned: 'המום! חסל אותו.',
    podSilenced: 'הקבוצה חוסלה — אף אחד לא ראה כלום.',
    objPods: 'רשות: חסל כל קבוצת שומרים בלי אזעקה ({n}/{m})',
    move_strike: 'STRIKE',
    move_drop: 'DROP',
    move_takedown: 'חיסול',
    move_pull: 'משיכה',
    ...
    see: 'רואים',
    swapHint: 'Q/E ⇄',
    blockArmoured: 'משוריין — כוון מעליו',
    blockSees: 'הוא רואה אותך',
    blockFar: 'רחוק מדי',
    bestChain: 'השרשרת הכי ארוכה',
    movesUsed: 'סוגי חיסול שהשתמשת',
    controlsHtml: `
      <div class="ctl-grid">
        ...
        <div><b>F</b><span>משיכה · נשיאה · זריקה · שימוש</span></div>
        ...
        <div class="hl"><b>Q / E</b><span>כיוון היציאה · החלפת STRIKE ⇄ DROP</span></div>
      ...
      <p class="ctl-note">שלט: LT כיוון · RT פתיחה · LB/RB מרחק · חצים כיוון · X פעולה · B התכופפות · A קפיצה</p>`,
  },
};
