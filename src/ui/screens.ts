    ...
    this.show(`
      <div class="goal-screen">
        <div class="gs-inner">
          ...
          <p class="gs-line accent">אפשר להגיע רק למקום שנוגע במקום שכבר שלי.</p>
          <p class="gs-line">חוט · אדם · מכשיר · עדכון. כתוב על כל מקום איך מגיעים אליו.</p>
          <div class="gs-rule"></div>
          <p class="gs-line accent">כל דבר שאני עושה — כתוב לידו כמה הוא רועש.</p>
          <p class="gs-line">שקט · ישימו לב · רועש. רועש זה לא אסור. זה פשוט עולה.</p>
          <div class="gs-rule"></div>
