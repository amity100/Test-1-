...
const AREAS: Area[] = [
  ...
  A('yarkon', 'נמל תל אביב', 'talking',
    'מסעדות על המים, שוק בשבת, ורציף עץ שכולם מצלמים.',
    18, -343, -1166, ['ramat_aviv', 'beach'],
    'מה שקורה כאן מצלמים ומעלים, וכל הארץ רואה את זה תוך דקה.'),
...
function buildPlaces(): Place[] {
  return [
    ...
    P('ta_water', 'water', 'מגדל המים בשרונה', 'תל אביב',
      'מגדל אבן ישן, ומתחתיו הצינורות והמשאבות שנותנים מים לחצי העיר.',
    ...
    P('trains', 'transport', 'נמל תל אביב', 'תל אביב',
      'רציפים, סירות, ואלפי אנשים שעוברים כאן כל ערב בדרך לאנשהו.',
    ...
    P('radio', 'homes', 'נווה צדק', 'תל אביב',
      'בתים נמוכים, חצרות, וסמטאות צרות שאף מכונית לא נכנסת אליהן.',
      'street', 'carmel', 0, -862, 1123, 2,
      { guard: 28, links: [
        wire('tv_news', 'אותה חברה מפעילה גם את מהדורת הערב.'),
      ] }),

    P('beach', 'homes', 'הטיילת', 'תל אביב',
      'מלונות, מצלמות, ומיליון פלאפונים ביום — ואף אחד לא סופר אותם.',
