...
const AREAS: Area[] = [
  ...
  A('center', 'לב העיר', 'moving',
    ...
    16, 130, 120, ['carmel', 'jaffa', 'rishon', 'ramla'],
...
function buildPlaces(): Place[] {
  return [
    ...
    P('bavli', 'homes', 'שכונת הבבלי', 'צפון תל אביב',
