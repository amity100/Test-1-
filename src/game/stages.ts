...
export const STAGES: Stage[] = [
  {
    ...
    steps: [
      S('s1_look', 'להסתכל במצלמה במסדרון',
        'לחץ על המצלמה במפה, ואז על "להסתכל מבפנים". משם רואים מי נמצא בקומה.',
        'floor_cam'),
      S('s1_dana', 'להשתלט על המחשב של דנה',
        'הוא מחובר אליי באותו חוט. לחץ עליו ואז על "להשתלט על המקום הזה".',
        'dana_pc'),
      S('s1_main', 'להשתלט על המחשב הראשי',
        'הוא נעול, ונפתח רק כשמישהו מחובר אליו. תסתכל טוב על מי יושב איפה — ותחשוב מה יגרום לה לקום.',
        'main'),
    ],
  },
  {
    ...
    steps: [
      S('s2_box', 'להשתלט על קופסת האינטרנט של הבניין',
        'הארון פתוח רק כשטכנאי עומד מולו. מה יגרום להם לקרוא לטכנאי?',
        'box'),
  ...
  },
  {
    ...
    steps: [
      S('s3_phone', 'לתפוס את הטלפון של איתן השומר',
        'הוא יושב מול המצלמה בלובי עם הטלפון ביד. המצלמה כבר שלי.',
        'eitan_phone'),
      S('s3_cam', 'להשתלט על המצלמה ברחוב',
        'איתן יוצא לסיבוב פעמיים בלילה עם הטלפון. כשהוא בחוץ — אני בחוץ.',
        'street_cam'),
